...
#   country_filter <- staByCountry(indicatorOneUpdated, years, country)
#   forceOne <- as.numeric(country_filter$value)
#   forceTwo <- as.numeric(country_filter$Value2)
#    p_dot_chart <- ggplot(country_filter,  aes(forceOne, forceTwo)) + geom_point()
# 
#   return(p_dot_chart)
# }
